...
# Use the 50cm utility
python ../nl50cm/getfilelist.py ${AHN5_ITEMS} "Maaiveldmodel (DTM) 5m" ahn5-files.txt
python ../nl50cm/getfilelist.py ${AHN6_ITEMS} "Maaiveldmodel (DTM) 5m" ahn6-files.txt

echo "merging: AHN5-DTM-5m: $(wc -l ahn5-files.txt) files + AHN6-DTM-5m: $(wc -l ahn6-files.txt) files"
