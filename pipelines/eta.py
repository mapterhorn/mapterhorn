"""Print ETA for aggregation/downsampling tasks based on done markers."""
...
def count_children(suffix):
    """Count tiles implied by filenames ending with the provided suffix."""
...
def eta(progress, start_time):
    """Estimate completion time given progress fraction and start timestamp."""
    now = datetime.now()
