"""Check mirror health by comparing file sizes and publish mirrorstatus.json."""
...
def get_size_by_filename():
    """Fetch primary download_urls.json and map filenames to sizes."""
    size_by_filename = {}
...
def get_mirrors():
    """Load mirror definitions from the repository."""
    r = requests.get(
...
def main():
    """Generate mirrorstatus.json and upload it to Cloudflare R2."""
